function generate_vertical_data(file_idx, emo, mode)
	...
	if strcmp(mode, 'train')
		...
		data = load(['./data/', emo, '/fine_tune.mat']);
		...
		save(['./data/',emo,'/momenta/log-f0-train-', num2str(file_idx), '.mat'], 'momentum_log_f0');
	...
	elseif strcmp(mode, 'valid')	
        ...
        size(momentum_ec)
        size(momentum_log_f0)
		save(['./data/',emo,'/momenta/f0-valid-', num2str(file_idx), '.mat'], 'momentum_f0');
		save(['./data/',emo,'/momenta/log-f0-valid-', num2str(file_idx), '.mat'], 'momentum_log_f0');
		save(['./data/',emo,'/momenta/ec-valid-', num2str(file_idx), '.mat'], 'momentum_ec');

	elseif strcmp(mode, 'test')
		data = load(['./data/', emo, '/test_mod_dtw_harvest.mat']);
        ...
        size(momentum_ec)
        size(momentum_log_f0)
		save(['./data/',emo,'/momenta/f0-test-', num2str(file_idx), '.mat'], 'momentum_f0');
		save(['./data/',emo,'/momenta/log-f0-test-', num2str(file_idx), '.mat'], 'momentum_log_f0');
		save(['./data/',emo,'/momenta/ec-test-', num2str(file_idx), '.mat'], 'momentum_ec');
	end
	exit;
