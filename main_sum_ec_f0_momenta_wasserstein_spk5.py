...
def train(train_dir, model_dir, model_name, random_seed, \
    ...
    lc_lm = 'lp_'+str(lambda_cycle_pitch) \
            ...
            + '_sum_mfc_spk5_'+emo_pair

    if tf_random_seed:
        folder_extension = 'sum_mfc_wstn_'+emo_pair+'_random_seed/'
    else:
        folder_extension = 'sum_mfc_wstn_spk5_'+emo_pair+'/'
    ...
    data_train = scio.loadmat(os.path.join(train_dir, emo_pair+'_unaligned_train_5_7_sum_mfc.mat'))
    data_valid = scio.loadmat(os.path.join(train_dir, emo_pair+'_unaligned_valid_5_7_sum_mfc.mat'))
