...
from nn_models.model_analyze_weights_dropout import VariationalCycleGAN
...
def train(train_dir, model_dir, model_name, random_seed, 
        ...
        tensorboard_log_dir, generator_learning_rate=1e-06, 
        discriminator_learning_rate=1e-03, pre_train=None, 
...
#            +"_lmo_"+str(lambda_momenta) + '_analyze_weights'
    ...
    model = VariationalCycleGAN(dim_pitch=1, dim_mfc=23, 
            n_frames=n_frames, keep_rate=0.5, 
            pre_train=pre_train, log_dir_name=lc_lm)
    ...
    for epoch in range(1,num_epochs+1):
        ...
        for i in range(n_samples // mini_batch_size):
            ...
            gen_mfc_B, gen_mom_A, gen_mom_B, gen_grad, disc_grad \
