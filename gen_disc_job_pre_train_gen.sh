...
singularity exec --nv ./tf.simg python3 main_pre_train_gen.py --lambda_cycle_pitch $1 --lambda_cycle_mfc $2 --lambda_momenta $3 --generator_learning_rate $4 --discriminator_learning_rate $5
