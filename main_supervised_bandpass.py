...
from nn_models.model_supervised_bandpass import VariationalCycleGAN
...
def train(train_dir, model_dir, model_name, random_seed, tensorboard_log_dir, 
    ...
    lc_lm = "lp_"+str(lambda_pitch) \
            + '_lm_'+str(lambda_mfc) \
            +"_lmo_"+str(lambda_momenta) + '_supervised_pre_train_bandpass'
    ...
    model = VariationalCycleGAN(dim_pitch=1, dim_mfc=23, bandpass_filters=64, 
    ...
    for epoch in range(1,num_epochs+1):
        ...
        for i in range(n_samples // mini_batch_size):
            ...
            gen_pitch_B, gen_mfc_B = model.train(mfc_A=mfc_A_feed, 
