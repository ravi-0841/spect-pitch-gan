...
def train(train_dir, model_dir, model_name, random_seed, \
    ...
    lc_lm = "lp_"+str(lambda_cycle_pitch) \
            ...
            + str(lambda_identity_mfc) + '_pre_trained_pitch_mfc_discriminate_wasserstein_reshuff'
    ...
    data_train = scio.loadmat(os.path.join(train_dir, 'train_reshuff_5.mat'))
    data_valid = scio.loadmat(os.path.join(train_dir, 'valid_reshuff_5.mat'))
...
#    validation_dir_default = './data/evaluation/'+emo_pair+"/"+emo_dict[emo_pair][0]
    ...
    train(train_dir=train_dir, model_dir=model_dir, model_name=model_name, 
          ...
          pre_train='./model/cmu-arctic/lp_0.0001_lm_0.0001_lmo_0.01_supervised_pitch_mfc_discriminate/cmu-arctic950.ckpt', 
