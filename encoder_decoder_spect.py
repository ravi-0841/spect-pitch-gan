...
from utils.model_utils import l1_loss, _interp_mat_mel2hz, \
                                spectral_loss
...
class AE(object):
    ...
    def __init__(self, encoder=encoder, decoder=decoder, dim_mfc=23, 
        ...
        self.interp_matrix = _interp_mat_mel2hz()
    ...
    def model_initializer(self):
        ...
        self.ae_loss = spectral_loss(y=self.input_mfc, y_hat=self.reconstruction)
...
if __name__ == '__main__':
    ...
    for epoch in range(1,num_epochs+1):
        ...
        model.save(directory='./model', filename='AE_spect.ckpt')
