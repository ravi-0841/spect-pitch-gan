...
singularity exec --nv ./tf_1_12.simg python3 main_supervised_energy_f0_momenta_discriminate_wasserstein.py --lambda_energy $1 --generator_learning_rate $2 --discriminator_learning_rate 1e-06
