...
from cyclegan_module_mceps import discriminator, generator_gatedcnn
from baseline_CycleGAN.utils import l1_loss, l2_loss, cross_entropy_loss
...
class CycleGAN(object):
    ...
    def train(self, input_A, input_B, lambda_cycle, lambda_identity, generator_learning_rate, discriminator_learning_rate):
        ...
        return generator_loss, discriminator_loss, generation_A, generation_B
