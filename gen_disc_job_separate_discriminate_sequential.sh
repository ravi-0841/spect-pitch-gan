...
singularity exec --nv ./tf.simg python3 main_separate_discriminate_sequential.py --lambda_cycle_mfc $1 --predictor_learning_rate 0.001 --discriminator_learning_rate 1e-05
