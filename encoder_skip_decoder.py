...
from utils.model_utils import l1_loss, mcd_loss
...
#                kernel_size=3, strides=1, name_prefix='residual_3')
        ...
        u1 = basic_blocks.upsample1d_block(inputs=r2, filters=256, 
                kernel_size=5, strides=1, shuffle_size=2, name_prefix='upsample_1')
...
class AE(object):
    ...
    def model_initializer(self):
        ...
        self.ae_loss = mcd_loss(y=self.input_mfc, y_hat=self.reconstruction)
...
#
#        model.save(directory='./model', filename='skip_connection_AE_net_mcd.ckpt')
#        
...
if __name__=='__main__':
    ...
    model = AE(dim_mfc=23)
    model.load('/home/ravi/Desktop/spect-pitch-gan/model/skip_connection_AE_net_mcd.ckpt')
    ...
    scwav.write('/home/ravi/Desktop/test_AE_4_mcd.wav', 16000, speech_recon)
