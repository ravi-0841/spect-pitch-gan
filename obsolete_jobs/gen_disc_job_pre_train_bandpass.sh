...
singularity exec --nv ./tf_1_12.simg python3 main_pre_train_bandpass.py --lambda_cycle_pitch $1 --lambda_cycle_mfc $2 --lambda_identity_mfc $3 --lambda_momenta $4 --generator_learning_rate $5 --discriminator_learning_rate $6
