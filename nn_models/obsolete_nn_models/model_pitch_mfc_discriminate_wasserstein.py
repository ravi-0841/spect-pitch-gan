...
from modules.modules_pitch_mfc_discriminate_wasserstein import sampler, \
...
#        self.discriminator_loss = (self.pitch_discriminator_loss + self.mfc_discriminator_loss) / 2.0
    ...
    def summary(self):
        ...
        with tf.name_scope('generator_summaries'):
            ...
            momenta_loss_summary = tf.summary.scalar('momenta_loss', self.momenta_loss)
            ...
            generator_summaries = tf.summary.merge([cycle_loss_pitch_summary, 
                                    ...
                                    momenta_loss_summary, generator_loss_A2B_summary, 
