...
class VariationalCycleGAN(object):
    ...
    def build_model(self):
        ...
        self.mfc_generation_A2B = self.generator(input_pitch=self.momentum_A2B, 
        ...
        self.mfc_cycle_A2A = self.generator(input_pitch=self.momentum_cycle_A2A, 
                input_mfc=self.mfc_generation_A2B, reuse=False, scope_name='generator_B2A')
        self.mfc_identity_A2B = self.generator(input_pitch=tf.zeros_like(self.momentum_A2B), 
        ...
        self.mfc_generation_B2A = self.generator(input_pitch=self.momentum_B2A, 
        ...
        self.mfc_cycle_B2B = self.generator(input_pitch=self.momentum_cycle_B2B, 
                input_mfc=self.mfc_generation_B2A, reuse=True, scope_name='generator_A2B')
        self.mfc_identity_B2A = self.generator(input_pitch=tf.zeros_like(self.momentum_B2A), 
...
#                + self.lambda_momenta * self.momenta_loss
        ...
        self.mfc_A2B_test = self.generator(input_pitch=self.momentum_A2B_test, 
        ...
        self.mfc_B2A_test = self.generator(input_pitch=self.momentum_B2A_test, 
