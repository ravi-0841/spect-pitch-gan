...
class VariationalCycleGAN(object):
    ...
    def __init__(self, dim_pitch=1, dim_mfc=23, n_frames=128, 
            ...
            sampler=sampler, lddmm=lddmm, mode='train', log_dir='./log', 
            pre_train=None):
    ...
    def train_grad(self, pitch_A, mfc_A, pitch_B, mfc_B, lambda_cycle_pitch, 
        ...
        generation_pitch_B, generation_mfc_B, generation_pitch_A, generation_mfc_A \
                = self.sess.run([self.pitch_generation_A2B, self.mfc_generation_A2B, 
...
#        self.writer.add_summary(generator_summaries, self.train_step)
        ...
        dis_A_0, dis_A_1, dis_B_0, dis_B_1, discriminator_loss, discriminator_grads, _ \
            = self.sess.run([self.discriminator_loss_input_A_real, 
                self.discriminator_loss_input_A_fake, 
                self.discriminator_loss_input_B_real, 
                self.discriminator_loss_input_B_fake, 
                self.discriminator_loss, self.discriminator_grads, 
                self.discriminator_train_op], 
                    feed_dict = {self.pitch_A_real:pitch_A, self.pitch_B_real:pitch_B, 
                        self.mfc_A_real:mfc_A, self.mfc_B_real:mfc_B, 
        ...
        momentum_B, generation_pitch_B, generation_mfc_B, momentum_A, \
                ...
                generator_A_adv_loss, generator_B_adv_loss, \
                generator_grads, _ \
                = self.sess.run([self.momentum_A2B, self.pitch_generation_A2B, 
                    ...
                    self.mfc_generation_B2A, self.gen_disc_loss, self.generator_loss_A2B, 
                    self.generator_loss_B2A, self.generator_grads, 
                    self.generator_train_op], 
...
#        self.writer.add_summary(discriminator_summaries, self.train_step)
        ...
        return generator_loss, discriminator_loss, generation_pitch_A, \
                ...
                generator_A_adv_loss, generator_B_adv_loss, dis_A_0, dis_A_1, \
                dis_B_0, dis_B_1
