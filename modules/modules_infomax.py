...
def generator(input_pitch, input_mfc, final_filters=1, reuse=False, \
                       keep_rate=1.0, scope_name='generator'):
...
def predictor(input_pitch, input_mfc, final_filters=23, reuse=False, \
                       keep_rate=1.0, scope_name='predictor'):
...
def discriminator(input_mfc_1, input_mfc_2, final_filters=1, 
        reuse=False, keep_rate=1.0, scope_name='discriminator'):
    ...
    with tf.variable_scope(scope_name) as scope:
        ...
        o2 = tf.transpose(o2, perm=[0, 2, 1], name='pitch_output')
