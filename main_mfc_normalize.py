...
from nn_models.model_separate_discriminate import VariationalCycleGAN
...
def train(train_dir, model_dir, model_name, random_seed, \
    ...
    mfc_A_train, mfc_B_train, means_A, means_B, stds_A, stds_B \
            = preproc.normalize_mfc(mfc_A_train, mfc_B_train)
    ...
    mfc_A_valid, mfc_B_valid = preproc.normalize_mfc(mfc_A_valid, 
            mfc_B_valid, means_A, means_B, stds_A, stds_B)
