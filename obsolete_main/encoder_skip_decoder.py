...
#
#        model.save(directory='./model', filename='skip_connection_AE_net_l1.ckpt')
#        
...
#    
    d = scwav.read('/home/ravi/Downloads/Emo-Conv/neutral-angry/all_above_0.5/angry/252.wav')
    ...
    scwav.write('/home/ravi/Desktop/test_skip_AE_5.wav', 16000, speech_recon)
