...
from nn_models.model_gated_embedding_wasserstein import VariationalCycleGAN
...
#    validation_dir_default = './data/evaluation/'+emo_pair+"/"+emo_dict[emo_pair][0]
    ...
    train(train_dir=train_dir, model_dir=model_dir, model_name=model_name, 
          ...
          pre_train='./model/cmu-arctic/lp_0.0001_lm_0.0001_lmo_0.01_supervised_gated_embedding_denoised/cmu-arctic975.ckpt', 
