...
from nn_models.model_check_discriminators_independently import VariationalCycleGAN
...
def train(train_dir, model_dir, model_name, random_seed, \
    ...
    data_train = scio.loadmat(os.path.join(train_dir, 'train_mod_dtw_5.mat'))
    data_valid = scio.loadmat(os.path.join(train_dir, 'valid_mod_dtw_5.mat'))
    ...
    for epoch in range(1,num_epochs+1):
        ...
        random_discriminator_sample = 10#np.random.randint(0, n_samples)
        ...
        for i in range(n_samples // mini_batch_size):
            ...
            gen_mfc_B, mom_A, mom_B, gen_grad, disc_grad, gen_A_adv_loss, \
            gen_B_adv_loss, dis_A_0, dis_A_1, dis_B_0, dis_B_1 \
            ...
            if i==random_discriminator_sample:
                print("dis_A_0 loss is %f" % dis_A_0)
                print("dis_A_1 loss is %f" % dis_A_1)
                print("dis_B_0 loss is %f" % dis_B_0)
                print("dis_B_1 loss is %f" % dis_B_1)
