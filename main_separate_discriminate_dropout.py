...
from nn_models.model_separate_discriminate_dropout import VariationalCycleGAN
...
def train(train_dir, model_dir, model_name, random_seed, \
    ...
    lc_lm = "lp_"+str(lambda_cycle_pitch) \
            ...
            +"_lmo_"+str(lambda_momenta) + '_sepdisc_drop'
    ...
    model = VariationalCycleGAN(dim_pitch=1, dim_mfc=23, \
                n_frames=n_frames, log_file_name=lc_lm, 
                pre_train=pre_train)
