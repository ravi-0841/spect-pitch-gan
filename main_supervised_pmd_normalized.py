...
def train(train_dir, model_dir, model_name, random_seed, tensorboard_log_dir, 
    ...
    lc_lm = "lp_"+str(lambda_pitch) \
            + '_lm_'+str(lambda_mfc) \
            +"_lmo_"+str(lambda_momenta) + '_supervised_pmd_normalized'
    ...
    """
    Saving mean and standard deviation for MFCC features
    """
    ...
    np.savez(os.path.join('./data', 'cmu_arctic_mfc_scalers.npz'), 
